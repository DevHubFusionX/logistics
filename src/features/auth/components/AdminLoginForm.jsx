...
export default function AdminLoginForm() {
  ...
  // Use DRY security lockout hook (120000ms is 2 minutes)
  const { lockoutTime, isLocked, registerFailure, resetAttempts } = useSecurityLockout('admin_portal', 5, 120000)
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-4 border rounded-xl focus:ring-4 focus:ring-sky-50 focus:border-sky-500 font-medium transition-all ${
                fieldErrors.email ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-sky-300'
              }`}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-12 py-4 border rounded-xl focus:ring-4 focus:ring-sky-50 focus:border-sky-500 font-medium transition-all ${
                fieldErrors.password ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-sky-300'
              }`}
              placeholder="••••••••"
              required
              disabled={isLoading || isLocked}
        ...
        <motion.button
          ...
          whileHover={{ scale: isLoading || isLocked ? 1 : 1.01 }}
          whileTap={{ scale: isLoading || isLocked ? 1 : 0.99 }}
        >
          {isLoading ? (
      ...
      <div className="mt-6 flex flex-col items-center gap-3">
        <Link
          to="/auth/admin/managers/login"
          className="text-sm text-sky-600 hover:text-sky-700 transition-colors font-semibold flex items-center gap-1.5"
        >
