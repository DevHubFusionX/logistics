...
export default function ManagerLoginForm() {
  ...
  // Use DRY security lockout hook (180000ms is 3 minutes)
  const { lockoutTime, isLocked, registerFailure, resetAttempts } = useSecurityLockout('manager_portal', 5, 180000)
          ...
          <div className="flex-1 flex flex-col justify-center -mt-10">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-sky-400/80 text-sm font-semibold tracking-widest uppercase">
                  Manager Portal
                </span>
              </div>
              ...
              <p className="text-slate-400 text-lg leading-relaxed max-w-md mb-10">
                Secure access portal for authorized management staff. Monitor fleet operations,
                oversee logistics, and manage teams.
              </p>
            </motion.div>
        ...
        >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-red-600/70 text-xs">
                    Retry in {Math.ceil(lockoutTime / 1000)} seconds
                  </p>
                </div>
              </motion.div>
            )}
              ...
              <div className="relative">
                <div
                  ...
                  style={{
                    ...
                    borderRight:
                      focusedField === 'email' ? '1px solid rgba(14,165,233,0.2)' : '1px solid rgba(0,0,0,0.06)'
                  }}
                >
                  <Mail
              ...
              <div className="relative">
                <div
                  ...
                  style={{
                    ...
                    borderRight:
                      focusedField === 'password' ? '1px solid rgba(14,165,233,0.2)' : '1px solid rgba(0,0,0,0.06)'
                  }}
                >
                  <Lock
                    className={`w-[18px] h-[18px] transition-colors duration-200 ${
                ...
                <input
                  ...
                  style={{
                    borderColor:
                      fieldErrors.password ? '#fca5a5' : focusedField === 'password' ? '#0ea5e9' : '#e2e8f0',
          ...
          <div className="relative my-7">
            ...
            <div className="relative flex justify-center">
              <span
                className="px-4 text-xs font-semibold text-slate-400 uppercase tracking-wider"
                style={{ background: 'linear-gradient(180deg, #fafbfc, #f0f4f8)' }}
              >
                Other portals
              </span>
            </div>
