    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-200">
        ...
        {assignedTruck ? (
          ...
          <div className="text-center py-3 bg-white/50 rounded-lg border border-dashed border-blue-200">
            <p className="text-sm text-gray-500 italic">No vehicle assigned. Assign a truck via the Fleet page.</p>
          </div>
        )}
      </div>
    </div>
