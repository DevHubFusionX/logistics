...
import { getStatusText } from '@/features/booking/utils/bookingUtils'
...
export default function BookingCard({ booking, onViewDetails, onEdit, onCancel, onPayNow, onAssignDriver, onRemoveTruck }) {
  ...
  const canReassign = !!onAssignDriver && (booking.status === 'confirmed' || booking.status === 'processing' || hasAssignment)
