...
import PricingRulesEditor from '@/features/admin/components/pricing/PricingRulesEditor'
import ClientPricingOverrides from '@/features/admin/components/pricing/ClientPricingOverrides'
import PricingSimulator from '@/features/admin/components/pricing/PricingSimulator'
import AuditLog from '@/features/admin/components/pricing/AuditLog'
import { usePricingRulesQuery, useClientOverridesQuery } from '@/features/admin/hooks/queries/useAdminQueries'
...
export default function PricingManagement() {
  ...
  // Prefetch data
  const { refetch: refetchRules } = usePricingRulesQuery()
  const { refetch: refetchOverrides } = useClientOverridesQuery()
  ...
  const handleRefresh = () => {
    refetchRules()
    refetchOverrides()
    showToast.success('Pricing data refreshed')
  }
    ...
    <div className="space-y-6 pb-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          title="Refresh all pricing data"
        >
