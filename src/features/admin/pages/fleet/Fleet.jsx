...
import AddTruckModal from '@/features/admin/components/fleet/AddTruckModal'
import FleetFilters from '@/features/admin/components/fleet/FleetFilters'
import FleetMetrics from '@/features/admin/components/fleet/FleetMetrics'
import TruckDetailModal from '@/features/admin/components/fleet/TruckDetailModal'
import { useFleetQuery, useDriversQuery } from '@/features/admin/hooks/queries/useAdminQueries'
...
function Fleet() {
  ...
  // Drivers not assigned to any truck (excluding the selected truck's current driver)
  const availableDrivers = useMemo(() => {
    return drivers.filter(d => !assignedDriverIds.has(d.id) || d.id === selectedTruck?.driverId)
  }, [drivers, assignedDriverIds, selectedTruck])
