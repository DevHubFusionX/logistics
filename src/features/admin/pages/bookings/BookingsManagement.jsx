...
export default function BookingsManagement() {
  ...
  const mappedBookings = useMemo(() => {
    ...
    return records.map(b => {
      ...
      return {
        ...
        status: b.status,
        amount: b.amount || b.price || b.shipping_fee,
  ...
  const stats = useMemo(() => ({
    ...
    confirmed:  mappedBookings.filter(b => ['confirmed', 'processing'].includes(b.status)).length,
  ...
  const handleDriverAssigned = () => {
    ...
    refetch()
    showToast.success('Success', 'Vehicle assigned and trip created successfully')
  }
