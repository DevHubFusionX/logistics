...
import {
  ...
  DriverModal,
  AddDriverModal
} from '@/features/admin/components/drivers'
import { useDriversQuery, useFleetQuery } from '@/features/admin/hooks/queries/useAdminQueries'
...
export default function Drivers() {
  ...
  // Approved trucks with no driver assigned (available for assignment)
  const availableTrucks = useMemo(() => {
    return fleet.filter(t => t.status === 'approved' && !t.driverId)
  }, [fleet])
