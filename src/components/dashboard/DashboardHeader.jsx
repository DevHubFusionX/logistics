        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm sm:text-base lg:text-lg">Welcome back, John Doe • ABC Corporation</p>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-2 sm:gap-4">
            ...
            <div className="relative">
              <button className="flex items-center gap-2 p-2 sm:p-3 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-xl transition-all">
