...
const items = [
  { icon: LayoutDashboard, label: 'Platform Overview', desc: 'The cold-chain intelligence layer.',       path: '/platform', color: 'bg-[#0056B8] text-white' },
  { icon: MapPin,          label: 'GPS & Fleet',        desc: 'Live location and route management.',     path: '/platform', color: 'bg-slate-900 text-white' },
  { icon: Thermometer,     label: 'Temp Monitoring',    desc: 'Real-time alerts and telemetry.',         path: '/platform', color: 'bg-slate-100 text-slate-900' },
  { icon: BarChart3,       label: 'Analytics',          desc: 'Insight-driven operational decisions.',   path: '/platform', color: 'bg-slate-100 text-slate-900' },
  { icon: Plug,            label: 'Integrations',       desc: 'Connect your ERP, WMS and TMS.',          path: '/platform', color: 'bg-slate-900 text-white' },
...
function PlatformMenu({ onClose }) {
  return (
    <div>
      <p className="text-[10px] font-bold tracking-widest text-slate-400 uppercase mb-5">Platform</p>
