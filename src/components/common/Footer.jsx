  ...
  return (
    <footer className="bg-[#0056B8] text-white px-4 sm:px-14 lg:px-20 pt-16 md:pt-20 pb-12 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* ── BOTTOM SECTION: Large Wordmark with Cold Chain Truck SVG ── */}
        <div className="hidden md:flex w-full items-center justify-center py-16 border-t border-white/10 select-none overflow-hidden text-center">
          <div className="flex items-center justify-center gap-4 lg:gap-6 hover:scale-[1.02] transition-all duration-700 cursor-pointer">
            
            {/* Wrapper for the letters to prevent parent flex gap between letters */}
            ...
            {/* Custom Footer Truck SVG (at the end of text, enters last) */}
            <motion.svg 
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.1 }}
              ...
              viewBox="0 0 612 612" 
              fill="currentColor"
              className="w-[7.5vw] h-[7.5vw] text-white/85 drop-shadow-[0_8px_20px_rgba(0,0,0,0.12)] self-center"
            >
              <g>
                <g>
