  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b">
        ...
        <p className="text-sm text-gray-600 mt-1">Last updated: {shipment.currentLocation.timestamp}</p>
      </div>
      ...
      <div className="relative h-96 bg-gray-100">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-lg font-semibold text-gray-900">Currently in {shipment.currentLocation.city}</p>
            <p className="text-sm text-gray-600 mt-1">Coordinates: {shipment.currentLocation.lat}, {shipment.currentLocation.lng}</p>
