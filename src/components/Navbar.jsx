            ...
            >
              {actionButtons.map((button, index) => (
                <Link key={index} to={button.to}>
                  <motion.button 
                    className={`hidden sm:block px-5 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                  ...
                  {actionButtons.map((button, index) => {
                    ...
                    return (
                      <Link key={index} to={button.to} onClick={() => setIsOpen(false)}>
                        <button className={`w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300 ${
                          button.variant === 'primary'
