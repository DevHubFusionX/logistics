...
import { impactAreas } from './whyus/impactData'
import ImpactStats from './whyus/ImpactStats'
import MobileCarousel from './whyus/MobileCarousel'
import StickyImages from './whyus/StickyImages'
import ImpactCard from './whyus/ImpactCard'
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          >
            ...
            <br />
            <span className="text-sky-600">Fast, reliable logistics with local expertise</span>
          </motion.h2>
        ...
        >
          <motion.div 
            ...
            className="bg-sky-50 rounded-3xl p-12 max-w-4xl mx-auto"
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.95 }}>
                <Link to="/booking/request" className="px-8 py-4 bg-sky-500 text-white font-bold rounded-xl hover:bg-sky-600 transition-colors inline-block">
                  Get a quote
                </Link>
              </motion.div>

              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link to="/services" className="px-8 py-4 border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:border-sky-300 hover:bg-sky-50 transition-all inline-block">
                  Learn more
                </Link>
              </motion.div>
            </div>
