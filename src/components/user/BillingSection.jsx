    ...
    <div className="divide-y divide-gray-100">
      ...
      <div className="p-8 lg:p-10">
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-gray-900 text-white rounded-xl hover:bg-blue-600 transition-all font-black text-[10px] uppercase tracking-widest shadow-lg shadow-gray-200 active:scale-95">
            ...
            <div key={method.id} className="group relative overflow-hidden flex flex-col p-6 bg-gray-50/50 hover:bg-white border border-transparent hover:border-gray-100 rounded-3xl transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Validity through {method.expiry}</p>
                </div>
      ...
      <div className="p-8 lg:p-10">
        ...
        {isError ? (
          <div className="p-12 text-center bg-rose-50/50 rounded-3xl border border-rose-100">
            <AlertCircle className="w-10 h-10 text-rose-500 mx-auto mb-4" />
            <h4 className="text-lg font-black text-gray-900 mb-2 tracking-tight">Telemetry Interruption</h4>
            <p className="text-xs text-gray-500 max-w-xs mx-auto mb-6 leading-relaxed">Failed to establish connection with the historical ledger vault. Check network integrity.</p>
          ...
          <div className="p-16 text-center bg-gray-50/50 rounded-3xl border border-dashed border-gray-200">
            ...
            <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">No transaction history detected</p>
          </div>
        ) : (
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-gray-50/50 border-b border-gray-100">
                    <th className="py-5 px-6 text-[9px] font-black text-gray-400 uppercase tracking-[0.15em]">Certificate ID</th>
                    <th className="py-5 px-6 text-[9px] font-black text-gray-400 uppercase tracking-[0.15em]">Settlement Date</th>
                    <th className="py-5 px-6 text-[9px] font-black text-gray-400 uppercase tracking-[0.15em]">Authorized Capital</th>
                    <th className="py-5 px-6 text-[9px] font-black text-gray-400 uppercase tracking-[0.15em]">Audit State</th>
                    <th className="py-5 px-6 text-right text-[9px] font-black text-gray-400 uppercase tracking-[0.15em]">Actions</th>
                  </tr>
                </thead>
                  ...
                  {invoices.map((invoice) => (
                    <tr key={invoice.id} className="hover:bg-blue-50/30 transition-colors duration-200 cursor-default group">
                      <td className="py-5 px-6">
                        <span className="text-sm font-black text-gray-900 group-hover:text-blue-600 transition-colors uppercase tracking-tight">{invoice.id}</span>
                      </td>
                      <td className="py-5 px-6">
                        <span className="text-[11px] font-bold text-gray-500 font-mono bg-gray-100 px-2 py-1 rounded-md">{invoice.date}</span>
                      </td>
                      <td className="py-5 px-6">
                        <span className="text-sm font-black text-gray-900 group-hover:scale-105 inline-block transition-transform">{invoice.amount}</span>
                      </td>
                      <td className="py-5 px-6">
