                ...
                {additionalServices.map((service, index) => (
                  <div
                    ...
                    className={`relative rounded-2xl overflow-hidden shadow-lg transition-all duration-300 ${
                      activeIndex === index ? 'ring-4 ring-primary scale-105' : 'opacity-60'
                    }`}
                  >
                    <img
                      src={service.image}
                    ...
                    <div className={`absolute inset-0 transition-colors ${
                      activeIndex === index ? 'bg-black/20' : 'bg-black/50'
                    }`} />
                  ...
                  >
                    <div className="flex items-start gap-6 mb-6">
                      <motion.div
                        ...
                        className="w-16 h-16 bg-primary rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg"
                      >
                      ...
                      <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div className="p-6">
                          ...
                          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                            <Link
                              to="/booking/request"
                              className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 text-white rounded-xl font-semibold transition-colors"
                              style={{ backgroundColor: '#00843D' }}
                            >
                              Learn More
                              <ArrowRight className="w-4 h-4" />
